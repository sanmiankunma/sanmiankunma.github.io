(function ($) {
    ...
    if (typeof (IcarusThemeSettings) !== 'undefined' &&
        ...
        if (typeof (ClipboardJS) !== 'undefined' && clipboard) {
            $('figure.highlight').each(function () {
                ...
                var button = '<a href="javascript:;" class="copy" title="复制" data-clipboard-target="#' + id + ' .code"><i class="fas fa-copy"></i></a>';
                $(this).attr('id', id);
    ...
    if ($toc.length > 0) {
        ...
        $('.card .catalogue').on('click', toggleToc);
    }
    ...
    // click handler for Bulma delete
